...
def StitchImages(BaseImage, SecImage):
    ...
    StitchedImage=StitchedImage[200:StitchedImage.shape[0]-200, 100:StitchedImage.shape[1] - 100]

    #if Correction[0]==0:
    #   bluredge =cv2.blur( StitchedImage[0:StitchedImage.shape[0],BaseImage.shape[1]-50:BaseImage.shape[1]+50],(10,10))
    #    plt.imshow(bluredge)
    #   plt.show()
    #    StitchedImage[0:StitchedImage.shape[0], BaseImage.shape[1] - 50:BaseImage.shape[1] + 50]= bluredge


    #StitchedImage = cv2.addWeighted(StitchedImage, 0.3, BaseImage, 0.7, 0.0)
...
if __name__ == "__main__":
    ...
    Image1 = cv2.imread("images/a/1.jpg")
    Image2 = cv2.imread("images/a/2.jpg")

    Image4 = cv2.imread("images/a/4.jpg")
    Image5 = cv2.imread("images/a/5.jpg")
    ...
    StitchedImage1 = StitchImages(Image1, Image2)
    StitchedImage2 = StitchImages(Image4, Image5)
    #repeat

    Image3 = cv2.imread("images/a/3.jpg")
    StitchedImage3 = StitchImages( Image3,StitchedImage1 )
    StitchedImage4 = StitchImages(StitchedImage3, StitchedImage2)


    #Image3 = cv2.imread("cc.jpg")
    plt.imshow(StitchedImage4)
    plt.show()
    ...
    cv2.imwrite('good.jpg', StitchedImage4)
